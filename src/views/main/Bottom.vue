<template>
  <div class="tool">
    <div class="control">
      ...
      <div class="info">
        <div class="song">
          <span id="sname" :title="songInfo.name || ''">{{
            songInfo.name
          }}</span>
          <span id="sartist" @click="toSinger" :title="songInfo.artist || ''"
